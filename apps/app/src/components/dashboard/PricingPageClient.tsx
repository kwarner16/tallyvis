...
import { savePricingRulesAction } from "@/lib/pricingActions";
...
export function PricingPageClient({ initialConfiguration }: { initialConfiguration: PricingConfiguration }) {
  const [configuration, setConfiguration] = useState(initialConfiguration);
  const [savedRules, setSavedRules] = useState(initialConfiguration.rules);
  ...
  function setRules(nextRules: WindowCleaningPricingRules) {
    setConfiguration((current) => ({ ...current, rules: nextRules }));
